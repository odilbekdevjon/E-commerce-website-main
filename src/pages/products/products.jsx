                ...
                <div className="container">
                    <div className="products flex">
...

                            {
                                category?.map(item => (
                                    <div key={item.id} className="mt-5">
                                        <h3 onClick={() => changeProducts(item.id)} className="text-[18px] mb-4 cursor-pointer hover:text-blue-700">{item?.[`name_${i18n.language}`]}</h3>
                                    </div>
                                ))
                            }
                        </div>
                        <div className="products__right">
                            ...
                            <ul className="main__list flex  mb-10">
