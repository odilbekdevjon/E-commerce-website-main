                    ...
                    <div className="container">
                        <div className="contact mt-40 flex">
                            ...
                            <div className="contact__right">
                                <form action="">
                                    <div className="">
                                        <input className="contact__form-input p-5 rounded-lg border-b-2 border-solid border-black mb-5 w-80" type="text" placeholder="Name" />
                                    </div>
                                    <div className="">
                                        <input className="contact__form-input p-5 rounded-lg border-b-2 border-solid border-black mb-5 w-80" type="email" placeholder="Email" />
                                    </div>
                                    <div className="">
                                        <input className="contact__form-input p-5 rounded-lg border-b-2 border-solid border-black mb-5 w-80" type="tel" placeholder="Phone" />
                                    </div>
                                    <div className="">
                                        <textarea className="contact__form-input p-5 rounded-lg border-b-2 border-solid border-black w-80" type="text" placeholder="Message"></textarea>
                                    </div>
