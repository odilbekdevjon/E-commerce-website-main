                    ...
                    <div className="container">
                        ...
                        <div className="carts flex">
                            ...
                            <div className="carts__right w-[400px] h-64 mt-14 ml-5 border-2 border-solid p-2 rounded-lg">
                                ...
                                <p className="mt-3 opacity-[0.6] ">{t("cartTitle3")} ({}) </p>
                                <div className="mt-3 text-center border-2 border-solid border-blue-600  text-blue-700 p-1">Yetkazib berish data</div>
                                ...
                                <Link className="block" to={'/adress'}>
                                    <button className="p-3 bg-blue-800 text-white rounded-lg mt-4 w-[100%]">Rasmiylashtirishga o'tish</button>
                                </Link>
                            </div>
                        </div>
                    </div>
